...
import com.example.administrator.emotionalappuse.mainframe.ClientMainActivity;
...
//    private View mLoginFormView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mSignInButton = (Button) findViewById(R.id.denglu);
        ...
        Button mRegisterButton = (Button) findViewById(R.id.newuser_zhuce);
        mRegisterButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                AppCompatActivity appCompatActivity = myService.getAppCompatActivity();
                appCompatActivity.startActivity(
                        new Intent(appCompatActivity, RegisterActivity.class));
            }
        });
//
//        Button mTeacherRegisterButton = (Button) findViewById(R.id.teacher_register_button);
//        mTeacherRegisterButton.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                AppCompatActivity appCompatActivity = myService.getAppCompatActivity();
//                appCompatActivity.startActivity(
//                        new Intent(appCompatActivity, TeacherRegisterActivity.class));
//            }
//        });
...
//    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String message = "login" + "\t" + mEmail + "\t" + mPassword;
//            String message = "allUserIformationRequest";
...
//            showProgress(false);
    ...
    public class MyServiceConn implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            myService.setAppCompatActivity(LoginActivity.this);
        }
